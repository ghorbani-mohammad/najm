                ...
                <div class="x_content">
                    <form method="post" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 ">
                                <select name="info[education_level]" class="col-md-12">
                                    ...
                                    <option value="{{\App\Models\Personnel::Tahsilat_KarshenasiArshad}}">کارشناسی ارشد</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 ">
                                <input type="text" id="marital_status" name="info[marital_status]" Lang="fa-IR"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-10 ">
                                    ...
                                    @if($errors->has('office_address'))
                                        <h5 style="color: red ;direction: rtl ; margin-top: 40px; margin-bottom: -3px">
                                            {{$errors->first('office _address')}}</h5>
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
