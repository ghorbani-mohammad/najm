                ...
                <div class="x_content">
                    <form method="post" data-parsley-validate class="form-horizontal form-label-left"
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-2 " for="type">نوع نشریه
                            </label>
                            <label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-2 " for="shomare_az">شماره از</label>
                            ...
                            <label class="control-label col-md-2 col-sm-2 " for="shomare_ta">شماره تا</label>
                            <div class="col-md-4 col-sm-4 ">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-2 " for="tarikh_az">تاریخ از</label>
                            <div class="col-md-4 col-sm-4 ">
                                <input type="text" id="tarikh_az" name="tarikh_az" Lang="fa-IR"
                                       value="{{ old("tarikh_az") }}"
                                       class="form-control col-md-7 date-it-is">
                                @if($errors->has("tarikh_az"))
                                    <h5 style="color: red ;direction: rtl ; margin-top: 40px; margin-bottom: -3px">
                                        {{$errors->first("tarikh_az")}}</h5>
                                @endif
                            </div>
                            <label class="control-label col-md-2 col-sm-2 " for="tarikh_ta">تاریخ تا</label>
                            <div class="col-md-4 col-sm-4 ">
                                <input type="text" id="tarikh_ta" name="tarikh_ta" Lang="fa-IR"
                                       value="{{ old("tarikh_ta") }}"
                                       class="form-control col-md-7 date-it-is">
                                @if($errors->has("tarikh_ta"))
                                    <h5 style="color: red ;direction: rtl ; margin-top: 40px; margin-bottom: -3px">
                                        {{$errors->first("tarikh_ta")}}</h5>
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
