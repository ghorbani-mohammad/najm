                                    ...
                                    @foreach($publications as $publication)
                                        @foreach($publication->evaluations as $evaluation)
                                            <tr>
                                                ...
                                                <td style="color: {{$evaluation->getEvaluationColor($evaluation->bazkhord_tasir_gozari)}}" class="tasirgozarii">{{$evaluation->bazkhord_tasir_gozari}}</td>
