<div class="row">
    ...
    <div class="form-group">
        <label class="control-label col-md-2 col-sm-2 " id="heyat_sardabir_label" for="heyat_sardabir">سردبیر
        </label>
        ...
        <label class="control-label col-md-2 col-sm-2 " id="heyat_modir_masool_label" for="heyat_modir_masool">مدیر
            مسئول
        </label>
        <div class="col-md-4 col-sm-4 ">
    ...
    <div class="form-group">
        <label class="control-label col-md-2 col-sm-2 " id="heyat_nazer_ali_label" for="heyat_nazer_ali">ناظر
            عالی
        </label>
        <div class="col-md-4 col-sm-4 ">
        ...
        <label class="control-label col-md-2 col-sm-2 " id="heyat_nazer_elmi_label" for="heyat_nazer_elmi">ناظر
            علمی
        </label>
        <div class="col-md-4 col-sm-4 ">
    ...
    <div class="form-group">
        <label class="control-label col-md-2 col-sm-2 " id="heyat_nazer_fani_label" for="heyat_nazer_fani">ناظر
            فنی
        </label>
        <div class="col-md-4 col-sm-4 ">
        ...
        <label class="control-label col-md-2 col-sm-2 " id="heyat_modir_ejrayi_label" for="heyat_modir_ejrayi">مدیر
            اجرایی
        </label>
        <div class="col-md-4 col-sm-4 ">
    ...
    <div class="form-group">
        <label class="control-label col-md-2 col-sm-2 " id="heyat_tarrahe_jeld_label" for="heyat_tarrahe_jeld">طراح
            جلد
        </label>
        <div class="col-md-4 col-sm-4 ">
        ...
        <label class="control-label col-md-2 col-sm-2 " id="heyat_virastar_elmi_label"
    ...
    <div class="form-group">
        <label class="control-label col-md-2 col-sm-2 " id="heyat_virastar_adabi_label"
        ...
        <label class="control-label col-md-2 col-sm-2 " id="heyat_nemoone_khan_label" for="heyat_nemoone_khan">نمونه‌خوان
        </label>
        <div class="col-md-4 col-sm-4 ">
        ...
        <label class="control-label col-md-2 col-sm-2 " id="tahie_konande" for="tahie_konande">مولف/مترجم
        </label>
        <div class="col-md-4 col-sm-4 ">
