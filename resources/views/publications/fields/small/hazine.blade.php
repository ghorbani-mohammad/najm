<div class="row">
    ...
    <div class="form-group">
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_maghalat_label" for="hazine_maghalat">حق الزحمه مقالات
        </label>
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_type_label" for="hazine_type">حق الزحمه تایپ
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_safhe_arayi_label" for="hazine_safhe_arayi">حق الزحمه صفحه آرایی
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_tarahi_jeld_label" for="hazine_tarahi_jeld">حق الزحمه طراحی جلد
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
    ...
    <div class="form-group">
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_davaran_label" for="hazine_davaran">حق الزحمه داوران
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_nezarat_fani_label" for="hazine_nezarat_fani">حق الزحمه نظارت فنی
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_nezarat_adabi_label" for="hazine_nezarat_adabi">حق الزحمه نظارت ادبی
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_chap_label" for="hazine_chap">هزینه چاپ
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
    ...
    <div class="form-group">
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_manabe_mostanadat_label" for="hazine_manabe_mostanadat">هزینه منابع و مستندات
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_moshavere_label" for="hazine_moshavere">حق الزحمه مشاوره
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_elsagh_ghardad_label" for="hazine_elsagh_ghardad">هزینه الصاق قرارداد‌های مربوطه
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="hazine_majmooe_label" for="hazine_majmooe">مجموع هزینه‌ها
        </label>
        <div class="col-md-2 col-sm-2 col-xs-2">
