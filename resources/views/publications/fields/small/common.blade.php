<div class="row">
    ...
    <div class="form-group">
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="sal_label" for="sal">سال
        </label>
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="fasl_label" for="fasl">فصل
        </label>
        <div class="col-md-1 col-sm-1 col-xs-1">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="shomare_mosalsal_label" for="shomare_mosalsal">شماره
            مسلسل
        </label>
        <div class="col-md-1 col-sm-1 col-xs-1">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="shomare_label" for="shomare">شماره
        </label>
        <div class="col-md-1 col-sm-1 col-xs-1">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="tarikhe_enteshar_label" for="tarikhe_enteshar">تاریخ
            انتشار
        </label>
        <div class="col-md-1 col-sm-1 col-xs-1">
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="shomaregan_label" for="shomaregan">شمارگان
        </label>
        <div class="col-md-1 col-sm-1 col-xs-1">
    ...
    <div class="form-group">
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="title_label"
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="title_en_label"
    ...
    <div class="form-group">
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="authors_label"
        ...
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="moassese_montasher_konande_label"
    ...
    <div class="form-group">
        <label class="control-label col-md-1 col-sm-1 col-xs-1" id="tahie_konande_label"
