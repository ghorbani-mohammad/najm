            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form method="post" data-parsley-validate class="form-horizontal form-label-left"
                        ...
                        @include('publications.fields.common', ['new' => false, 'publication' => $publication])
                        <div class="ln_solid"></div>
                        @include('publications.fields.related', ['new' => false, 'publication' => $publication])
                        <div class="ln_solid"></div>
                        @if($hasMaghale)
                            ...
                            <div class="ln_solid"></div>
                        @endif
                        @include('publications.fields.tahrir', ['new' => false, 'publication' => $publication])
                        <div class="ln_solid"></div>
                        @if($isAdmin)
                            @include('publications.fields.hazine', ['new' => false, 'publication' => $publication])
                            <div class="ln_solid"></div>
                        @endif
