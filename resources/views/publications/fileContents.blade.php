...
@section('content')
    ...
    <div class="modal fade bs-example-modal-lg-file" tabindex="-1" role="dialog" style="display: none;"
         aria-hidden="true">
        <form method="post" action="{{route('publication.files.add', ['publication' => $publication->id])}}"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">اضافه کردن محتوای متنی</h4>
