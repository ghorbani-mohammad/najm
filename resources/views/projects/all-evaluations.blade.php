...
@section('content')
                                    ...
                                    <table id="myTable" class="table table-bordered">
                                        ...
                                        @foreach($project->evaluations as $evaluation)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-warning btn-sm" href="{{route('project.evaluations.view', ['evaluation' => $evaluation->id])}}">ویرایش</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-danger btn-sm" href="{{route('project.evaluations.delete', ['evaluation' => $evaluation->id])}}">حذف</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
        <form method="post" action="{{route('project.evaluations.add', ['project' => $project->id])}}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 ">
                                <input type="file" id="type" name="addEvaluationFile[file]" Lang="fa-IR" value="{{ old('file') }}"
                                       class="form-control col-md-7 ">
                                @if($errors->has('file'))
                                    <h5 style="color: red ;direction: rtl ; margin-top: 40px; margin-bottom: -3px">
